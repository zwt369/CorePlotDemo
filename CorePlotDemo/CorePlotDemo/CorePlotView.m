...
@interface CorePlotView ()<CPTPlotDataSource,CPTPlotSpaceDelegate,CPTPlotAreaDelegate,CPTScatterPlotDelegate,CPTAxisDelegate>{
...
- (void)prepaireGraph {
    ...
    plotSpace.xRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithFloat:0] length:[NSNumber numberWithInt:10]];
    plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithInt:0] length:[NSNumber numberWithInt:lengthOfY]];
    plotSpace.globalYRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithInt:0] length:[NSNumber numberWithInt:lengthOfY]];// 固定y轴坐标
    ...
    dashDataLinePlot.areaBaseValue =[NSNumber numberWithFloat:1];
  ...
  //  y.orthogonalCoordinateDecimal = CPTDecimalFromDouble(0);
    ...
    y.labelOffset                 = -2;
    y.visibleAxisRange            = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithInt:0] length:[NSNumber numberWithInt:lengthOfY]];
    y.delegate                    = self;
    // Set axes
    ...
    barPlot.baseValue = [NSNumber numberWithInt:1];
    ...
    // 图形向左偏移： 0.25
    barPlot.barOffset = [NSNumber numberWithFloat:0.5] ;
    ...
    barPlotLast.baseValue = [NSNumber numberWithFloat:1];
    barPlotLast.barWidth = [NSNumber numberWithFloat:0.3];
    ...
    // 图形向左偏移： 0.25
    barPlotLast.barOffset = [NSNumber numberWithFloat:0.5] ;
    //id ，根据此 id 来区分不同的 plot ，或者为不同 plot 提供不同数据源
...
- (void)refresh {
    ...
    if (shouldRefresh) {
        ...
        plotSpace.yRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithFloat:0]length:[NSNumber numberWithInt:lengthOfY]];
        plotSpace.globalYRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithInt:0] length:[NSNumber numberWithInt:lengthOfY]];// 固定y轴坐标
        y.visibleAxisRange            = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithInt:0]length:[NSNumber numberWithInt:lengthOfY]];
    ...
    if (dataArr.count + positionOfLeft > lengthOfX) {
        ...
        plotSpace.xRange = [CPTPlotRange plotRangeWithLocation:[NSNumber numberWithUnsignedInteger:location] length:[NSNumber numberWithInt:lengthOfX]];
    }
    ...
    switch ( coordinate ) {
        case CPTCoordinateX:
            if (changedRange.locationDouble < -1) {
                changedRange =[CPTMutablePlotRange plotRangeWithLocation:[NSNumber numberWithFloat:-0.9] length:[NSNumber numberWithFloat:newRange.lengthDouble]];
            }
            if (changedRange.lengthDouble > 10) {
                changedRange = [CPTMutablePlotRange plotRangeWithLocation:[NSNumber numberWithFloat:newRange.lengthDouble] length:[NSNumber numberWithInt:lengthOfX]];
            }
            break;
            
        case CPTCoordinateY:
            if (lengthOfY != standardLengthOfY && lengthOfY > standardLengthOfY) {
                changedRange.length = [NSNumber numberWithInt:lengthOfY];
...
-(BOOL)axis:(CPTAxis *)axis shouldUpdateAxisLabelsAtLocations:(NSSet *)locations{
    ...
    for (NSDecimalNumber * tickLocation in locations) {
       ...
       // newLabel.tickLocation   = [NSNumber numberWithFloat:tickLocation.decimalValue];
        newLabel.tickLocation = [NSNumber numberWithFloat:200];
